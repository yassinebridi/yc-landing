...
import imageOne from "../../../assets/image/landing-2/myapp1.png"
      ...
      <div className="hero-area-2">
        <div className="container">
          <div className="row justify-content-center align-items-center">
            <div
              className="col-lg-6 col-md-9 order-lg-0 order-1"
              data-aos="fade-right"
              data-aos-duration={800}
              data-aos-once="true"
            >
              <div className="hero-area-content">
                <h2>The easiest way to get a gym membership.</h2>
                <p>
                  How about saving money? You will get the most of your
                  membership. You will get your gym membership with a good
                  price.
                </p>
                <div className="hero-area-btn-group">
                  <Link to="/">
                    <img src={playStoreButton} alt="store button" />
                  </Link>
                  <Link to="/">
                    <img src={appStoreButton} alt="store button" />
                  </Link>
                </div>
              </div>
            </div>
            <div
              className="col-lg-6 col-md-9 col-sm-11 order-lg-1 order-0"
              data-aos="fade-left"
              data-aos-duration={800}
              data-aos-once="true"
            >
              <div className="hero-area-image-group text-center">
                ...
                <div className="image-2">
                  <img src={imageTwo} alt="Hero" height="493px" width="279" />
                </div>
